...
import 'package:new_admin/screen/add_product.dart';
import 'package:new_admin/screen/edit_product.dart';
          ...
          children: [
            ...
            Expanded(
              ...
              child: Container(
                ...
                child: productsData.productsList.isNotEmpty
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              String productAvailable = productsData
                                  .productsList[index].isAvailable
                                  .toString();
                              print(
                                  'product name :  ${productsData.productsList[index].name}');
                              ...
                              print(
                                  'product discount type:  ${productsData.productsList[index].price![0].discountType}');
                                            ...
                                            child: Container(
                                              decoration: BoxDecoration(
                                                  ...
                                                  image: DecorationImage(
                                                      fit: BoxFit.cover,
                                                      image: NetworkImage(
                                                          "https://apihomechef.antopolis.xyz/images/${productsData.productsList[index].image ?? ""}"))),
                                            ),
                                          ),
                                          Expanded(
                                            flex: 6,
