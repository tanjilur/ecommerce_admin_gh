...
import 'package:new_admin/screen/tab_item/home_page.dart';
import 'package:new_admin/screen/tab_item/order_page.dart';
import 'package:new_admin/screen/tab_item/product_page.dart';
import 'package:new_admin/screen/tab_item/profile_page.dart';
...
class _TabMenuState extends State<TabMenu> {
  ...
  List<Widget> pages=[HomePage(),
    CategoryPage(),ProductPage(),OrderPage(),ProfilePage()];
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.production_quantity_limits_rounded),label: "Orders",),
          BottomNavigationBarItem(icon: Icon(Icons.support),label: "Profile",),
        ],
      ),
    );
  }
