...
import 'package:new_admin/model/orders_model_search.dart';
...
class OrderSearchHere extends SearchDelegate<Orders> {
                            ...
                            child: RawScrollbar(
                              ...
                              child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    int q = order
                                        .orderFoodItems![index].pivot!.quantity!;
                                    int p = order.orderFoodItems![index].price![0]
                                        .discountedPrice!;
                                    var total = q * p;
                                    return ListTile(
                                      title: Text(
                                    ...
                                    children: [
                                      ...
                                      MCustomSwitch(
                                        ...
                                        onChanged: (value) async {
                                          ...
                                          onProgress = true;
                                          print("$payment");
                                          int orderId = myList[index].id!.toInt();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    final myList = query.isEmpty
        ...
        : recentOrders.orderList
            .where(
                (element) => element.user!.name!.toLowerCase().startsWith(query))
            .toList();
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: myList.isEmpty
